...
import LogoVs21 from "../assets/logo/vs21Logo.svg";
import LogoRender from "../assets/logo/renderLogo.svg";
...
export const Navbar = () => {
  ...
  const sendEmail = (e) => {
    ...
    // sendEmail
    //   .send({
    //     SecureToken: "91e59fcf-43b0-45fa-989f-4b5addcd7483",
    //     Host: "smtp.mail.hosting.reg.ru",
    //     Username: "vusialstudio21@vs21.art",
    //     Password: "tuuyioNg1",
    //     To: "mail.vs21.art",
    //     From: "mail.vs21.art",
  ...
  return (
    <nav className="navbar">
      ...
      <>
        ...
        <Group position="center" w="15rem">
          <ul className=" text-white text-center">
            <div className="mb-4">
              <li onClick={() => setIsVs21(true)} className="cursor-pointer">
                <svg
                  width="100"
                  height="75"
                  viewBox="0 0 757 50"
              ...
              <li onClick={() => setIsVs21(false)} className=" cursor-pointer">
                <svg
                  width="100"
                  height="45"
                  viewBox="0 0 757 100"
            ...
            {isVs21 ? (
              <motion.div>
                <li>
                  <NavLink className=" active:text-yellow-300" to="/">

      ...
      <div className="flex justify-between h-496 px-12 md:px-28 items-center bg-black bg-opacity-70 absolute top-20 w-full">
        <div>
          <div>
            ...
            <h1 className="font-bold lg:text-6xl text-yellow-300 pt-4 md:text-5xl text-4xl">
          ...
          <div className="mt-10 flex">
            <button className="font-bold text-white px-8 py-3 md:px-12 md:py-5 border border-yellow-300 rounded-full text-sm md:text-base btn-hover hover:bg-yellow-300 hover:text-black focus:bg-yellow-300 focus:text-black">
              Забронировать
            </button>
            <div className="flex">
              <button className="ml-10 font-bold text-white p-3 md:p-5 border border-white rounded-full text-base btn-hover hover:bg-white hover:text-black">
                <BsFillPlayFill size={30} />
              </button>
              <p className="text-white m-auto ml-4 cursor-pointer">
                Презентация студии
              </p>
            </div>
          </div>
